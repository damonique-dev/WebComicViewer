...
class LastComicViewerView: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //Gesture
        let gesture: UILongPressGestureRecognizer = UILongPressGestureRecognizer(target: self, action: #selector(LastComicViewerView.longPressed(_:)))
