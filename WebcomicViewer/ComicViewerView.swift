...
class ComicViewerView: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //Gesture
        let gesture: UILongPressGestureRecognizer = UILongPressGestureRecognizer(target: self, action: #selector(ComicViewerView.longPressed(_:)))
