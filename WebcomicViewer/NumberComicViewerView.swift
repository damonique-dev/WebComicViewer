...
class NumberComicViewerView: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //Gesture
        let gesture: UILongPressGestureRecognizer = UILongPressGestureRecognizer(target: self, action: #selector(NumberComicViewerView.longPressed(_:)))
